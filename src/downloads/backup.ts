...
const uploadToS3 = async (filePath: string, key: string): Promise<void> => {
  try {
...
const listFilesRecursively = async (folder: string = "") => {
  try {
    ...
    console.error(
      `Error while listing files in folder ${folder}: ${
